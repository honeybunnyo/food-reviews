...
const Contact = () => {
  ...
  return (
    <Layout imageSrc="/restaurant.jpg" title='Contact'>
      ...
      <div className="max-w-md w-full space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">        
        <div className="space-y-4">
          ...
          <ContactItem
            ...
            label="GitHub"
            link="https://github.com/honeybunnyo"
            text="github.com/honeybunnyo"
          />
          <ContactItem
            icon={
            ...
            label="LinkedIn"
            link="https://linkedin.com/in/jxcqueline"
            text="linkedin.com/in/jxcqueline"
          />
        </div>
      </div>
    </div>
...
function ContactItem({ icon, label, link, text }) {
  return (
    <a
      href={link}
      target="_blank"
...
function EmailCopyItem({ icon, email }) {
